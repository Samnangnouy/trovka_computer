   ...
   <div class="content-wrapper">
      <div class="content-header">
         <div class="container-fluid">
            <div class="row mb-2">
               <div class="col-sm-6">
                  <h1 class="m-0">@if (isset($company)) Edit @else Add New @endif Company</h1>
               </div>
               <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                     <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
                     <li class="breadcrumb-item"><a href="{{ route('company.index') }}">Company name Manangement</a> </li>
                     <li class="breadcrumb-item active">@if (isset($company)) Edit @else Add New @endif Category</li>
                  </ol>
               </div>
            </div>
         </div>
                  ...
                  <div class="card card-info">
                     ...
                     @endif
                        ...
                        <div class="card-footer">
                           <div class="row">
                              <div class="col-6">
                                 <a href="{{ route('company.index') }}" class="btn btn-block btn-dark">Back</a>
                              </div>
                              <div class="col-6">
                                 @if (isset($company))
