...
<div class="content-wrapper">
   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1 class="m-0">Company name Manangement</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="/admin/dashboard">Dashboard</a></li>
                  <li class="breadcrumb-item active">Company name Manangement</li>
               </ol>
            </div>
            <!-- /.col -->
         </div>
       ...
       <div class="row">
         <div class="col-lg-12 margin-tb">
            <div class="pull-right">
                {{-- need role to see --}}
               <a class="btn btn-success" href="{{ route('company.create') }}"> <i class="far fa-plus-square"></i> Create </a>
            </div>
         </div>
      </div>
      <br>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            {!! Form::open(['method' => 'DELETE','route' => ['company.destroy', $item->id],'style'=>'display:inline']) !!}
