                            ...
                            <form action="{{ route('register.save') }}" method="POST" class="user">
                                ...
                                <div class="form-group">
                                        <input type="text" name="username"
                                            class="mb-1 form-control mb-1 form-control-user @error('username')-is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    <input type="email" name="email"
                                        class="mb-1 form-control mb-1 form-control-user @error('email')-is-invalid @enderror"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" name="password"
                                            class="mb-1 form-control mb-1 form-control-user @error('password')-is-invalid @enderror "
                                            id="exampleInputPassword" id="exampleInputPassword" placeholder="Password">
                                        @error('password')
                                        <span style="color: red;">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" name="password_confirmation"
                                            class="mb-1 form-control mb-1 form-control-user @error('password_comfirm')-is-invaild @enderror"
